...
export const CurrentCard = ({ isSelected }: CurrentCardProps) => {
  return (
    <motion.div
      whileHover={{
        y: -10,
    ...
    >
      ...
      <div className="relative w-full h-full rounded-xl overflow-hidden border border-slate-200/50">
        <motion.div
          className="w-full h-full bg-white flex flex-col pt-0"
          transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] }}
          whileHover={{ scale: 1.05 }}
        >
          <div className="h-16 bg-[#1e293b] w-full relative overflow-hidden" />
          ...
          <div className="p-6">
            ...
            <div className="h-2.5 w-full bg-[#1e293b] rounded-full mb-6" />
