...
export const VibrantCard = ({ isSelected }: VibrantCardProps) => {
  return (
    <motion.div
      whileHover={{
        y: -10,
    ...
    >
      ...
      <div className="relative w-full h-full rounded-xl overflow-hidden border border-slate-200/50">
        <motion.div
          className="w-full h-full bg-white flex flex-col p-6 gap-6"
          transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] }}
          whileHover={{ scale: 1.05 }}
        >
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-pink-500 rounded-xl transform -rotate-6 shadow-sm" />
            <div className="space-y-2 flex-1">
              <div className="h-3 w-3/4 bg-slate-900 rounded-full" />
              <div className="h-2 w-1/2 bg-pink-500 rounded-full" />
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="w-0.5 h-full shimmer bg-slate-100" />
            </div>
            <div className="flex-1 space-y-4 pt-1">
              <div className="p-4 bg-slate-50 rounded-lg shimmer space-y-2">
              ...
              <div className="space-y-2 pl-2">
                ...
                <div className="h-1.5 w-full shimmer rounded-full" />
                <div className="h-1.5 w-2/3 shimmer rounded-full" />
              </div>
            </div>
          </div>
        </motion.div>
