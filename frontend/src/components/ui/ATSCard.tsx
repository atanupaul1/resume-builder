// frontend/components/ui/ATSCard.tsx
'use client';
...
export const ATSCard = ({ isSelected }: ATSCardProps) => {
  return (
    <motion.div
      whileHover={{
        y: -10,
        boxShadow: "0 25px 50px -12px rgba(100, 116, 139, 0.2)"
      }}
    ...
    >
      ...
      <div className="relative w-full h-full rounded-xl overflow-hidden">
        <motion.div
          className="w-full h-full bg-slate-50/10 p-6 flex flex-col gap-8"
          transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] }}
          whileHover={{ scale: 1.05 }}
        >
          <div className="space-y-3 border-b border-slate-200 pb-6 pt-2">
            <div className="h-5 w-3/4 shimmer rounded-sm mx-auto bg-slate-200" />
            <div className="flex gap-4 justify-center items-center">
              <div className="h-1.5 w-16 shimmer rounded-full opacity-60" />
              <div className="w-1 h-1 rounded-full bg-slate-300" />
              <div className="h-1.5 w-20 shimmer rounded-full opacity-60" />
              <div className="w-1 h-1 rounded-full bg-slate-300" />
              <div className="h-1.5 w-16 shimmer rounded-full opacity-60" />
            </div>
          </div>

          {/* Machine-Readable Block Sections */}
          <div className="space-y-6">
            <div className="space-y-3">
              <div className="h-2 w-1/4 shimmer rounded-sm bg-slate-200" />
              <div className="h-[0.5px] w-full bg-slate-300" />
              <div className="space-y-2">
                <div className="h-1.5 w-full shimmer rounded-full opacity-40" />
                <div className="h-1.5 w-full shimmer rounded-full opacity-40" />
                <div className="h-1.5 w-4/5 shimmer rounded-full opacity-40" />
              </div>
            </div>
            
            <div className="space-y-3">
              <div className="h-2 w-1/5 shimmer rounded-sm bg-slate-200" />
              <div className="h-[0.5px] w-full bg-slate-300" />
              <div className="flex justify-between items-start">
                <div className="h-1.5 w-1/2 shimmer rounded-full opacity-40" />
                <div className="h-1.5 w-1/4 shimmer rounded-full opacity-40" />
              </div>
              <div className="h-1.5 w-full shimmer rounded-full opacity-40" />
            </div>
          </div>
      ...
      <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-white via-white/100 to-transparent pt-12 z-20">
        ...
        <p className="text-xs text-slate-400 font-medium mt-1">
          Machine-readable, standard industry format.
        </p>
      </div>
