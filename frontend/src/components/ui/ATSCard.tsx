  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full rounded-xl overflow-hidden">
        <motion.div
          className="w-full h-full bg-slate-50/30 p-6 flex flex-col gap-8"
          transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] }}
          whileHover={{ scale: 1.05 }}
        >
          {/* Simplified Header */}
          <div className="space-y-4 border-b border-slate-100 pb-8 text-center pt-4">
            <div className="h-5 w-2/3 shimmer rounded-full mx-auto" />
            <div className="flex gap-3 justify-center">
              <div className="h-1.5 w-12 shimmer rounded-full" />
              <div className="h-1.5 w-12 shimmer rounded-full" />
            </div>
          </div>
