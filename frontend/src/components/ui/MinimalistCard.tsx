// frontend/components/ui/MinimalistCard.tsx
'use client';
...
export const MinimalistCard = ({ isSelected }: MinimalistCardProps) => {
  return (
    <motion.div
      whileHover={{
        y: -10,
    ...
    >
        ...
        >
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <div className="h-2 w-1/4 shimmer rounded-full mb-4" />
            ...
            <div className="space-y-3">
              <div className="h-2 w-1/3 shimmer rounded-full mb-4" />
              <div className="space-y-2">
                <div className="h-1.5 w-full shimmer rounded-full" />
      ...
      <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-white via-white/100 to-transparent pt-12 z-20">
        ...
        <p className="text-xs text-slate-400 font-medium mt-1">
          Clean, high-density layout for experienced pros.
        </p>
      </div>
